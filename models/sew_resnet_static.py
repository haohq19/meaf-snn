# Copied from: https://github.com/fangwei123456/Spike-Element-Wise-ResNet/blob/main/imagenet/sew_resnet.py
# The weights are download from the official repo of SEW-ResNet: https://github.com/fangwei123456/Spike-Element-Wise-ResNet?tab=readme-ov-file
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        return out
def zero_init_blocks(model: nn.Module, connect_f: str):
...
class SEWResNet(nn.Module):
    ...
    def _make_layer(self, block, out_channels, blocks, stride=1, dilate=False, connect_f=None):
    ...
    def _forward_impl(self, x):
        ...
        return self.fc(x.mean(dim=0))  # x.shape = (N, C)
